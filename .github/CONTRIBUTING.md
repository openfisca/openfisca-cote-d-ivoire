# Contribuer à OpenFisca-Cote-d-Ivoire
...
Les évolutions d'OpenFisca-Cote-d-Ivoire doivent pouvoir être comprises par des réutilisateurs qui n'interviennent pas nécessairement sur le code. Le Changelog, rédigé en français, se doit donc d'être le plus explicite possible.
...
> Par exemple :
> # 13.0.0 - [#671](https://github.com/openfisca/openfisca-cote-d-ivoire/pull/671)
>
> ## 13.2.0 - [#676](https://github.com/openfisca/openfisca-cote-d-ivoire/pull/676)
>
> ### 13.1.5 - [#684](https://github.com/openfisca/openfisca-cote-d-ivoire/pull/684)
...
Certaines interventions sur OpenFica concernent à la fois [OpenFica-Core](https://github.com/openfisca/openfisca-core) et OpenFisca-Cote-d-Ivoire.
...
Dans ce cas, il peut être pertinent de faire tourner les tests d'OpenFisca-Cote-d-Ivoire en se basant sur une version non-publiée de Core, disponible sur une branche spécifique. Pour ce faire, éditer le fichier `circle.yml` comme suit :
